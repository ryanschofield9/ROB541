...
class LieGroupTangentVector(tb.TangentVector):
    ...
    @property
    def left(self):
        #print(f"self.configuration in left in liegroup.py: {self.configuration}")
        #print(f"self.configuration.inverse in left in liegroup.py: {self.configuration.inverse}")
        left_velocity = self * self.configuration.inverse
        #print(f"left_velocity in liegroup.py function left : {left_velocity}")
